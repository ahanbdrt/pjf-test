...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body bg-light">
            <form action="<?= base_url("jawaban/pof")?>" method="post">
                <table width="100%" cellspacing="0">
                    <tbody>
                        ...
                        <tr class="text-capitalize border-bottom border-dark">
                            <td>
                                <h5 class="mb-5 mt-4 text-dark text-center"><b><?=$s->isi_pof?></b></h5>
                                <div class="row mb-2 ml-4 mr-4 justify-content-center">
                                    <div class="ml-2">
                                        <label class="rounded btn btn-md btn-light" style="width:164px">Sangat tidak setuju<br>
                                            <input type="radio" class="form rad" name="<?= $s->id_pof?>" value="1" required>
                                        </label>
                                    </div>
                                    <div class="ml-2">
                                    <label class="rounded btn btn-md btn-light" style="width:164px">Tidak setuju<br>
                                        <input type="radio" class="form rad" name="<?= $s->id_pof?>" value="2" required>
                                        </label>
                                    </div>
                                    <div class="ml-2">
                                    <label class="rounded btn btn-md btn-light" style="width:164px">Netral <br>
                                        <input type="radio" class="form rad" name="<?= $s->id_pof?>" value="3" required>
                                        </label>
                                    </div>
                                    <div class="ml-3">
                                        <label class="rounded btn btn-md btn-light" style="width:164px">Setuju <br>
                                        <input type="radio" class="form rad" name="<?= $s->id_pof?>" value="4" required>
                                        </label>
                                    </div>
                                    <div class="ml-3">
                                        <label class="rounded btn btn-md btn-light" style="width:164px">Sangat setuju <br>
                                        <input type="radio" class="form rad" name="<?= $s->id_pof?>" value="5" required>
                                        </label>
                                    </div>
                                </div>
                            </td>
